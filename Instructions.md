...
- Your login: is mfwsuser4@demo.broadcom.com
...
- Your userid is CUST004.
- Your password CUST004.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS04 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS04 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST004.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST004.MARBLES.JCL(MARBCOPY)" --vasc`
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-04.git`
